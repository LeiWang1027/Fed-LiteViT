...
class FedLiteAdditiveAttention(nn.Module):
    """
    Fed-Lite Additive Attention module for SwiftFormer.
...
class SwiftFormerEncoder(nn.Module):
    """
    SwiftFormer Encoder Block for SwiftFormer. It consists of (1) Local representation module, (2) FedLiteAdditiveAttention, and (3) MLP block.
    Input: tensor in shape [B, C, H, W]
    Output: tensor in shape [B, C, H, W]
    """
    ...
    def __init__(self, dim, mlp_ratio=4.,
        ...
        self.attn = FedLiteAdditiveAttention(in_dims=dim, token_dim=dim, num_heads=1)
...
class SwiftFormerEncoder_nlr(nn.Module):
    """
    SwiftFormer Encoder Block for SwiftFormer. It consists of (1) Local representation module, (2) FedLiteAdditiveAttention, and (3) MLP block.
    Input: tensor in shape [B, C, H, W]
    Output: tensor in shape [B, C, H, W]
